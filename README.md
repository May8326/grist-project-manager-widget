...
**Widget URL:** `https://grist-project-manager-widget.vercel.app/`
...
3. Enter the custom widget URL:
   ```
   https://grist-project-manager-widget.vercel.app/
   ```
...
**URL du widget :** `https://grist-project-manager-widget.vercel.app/`
